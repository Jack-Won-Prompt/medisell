...
<style>
    ...
    .stdq-img-handle { position:absolute; width:10px; height:10px; background:var(--a-navy, #0b3d91); border:1.5px solid #fff; border-radius:2px; pointer-events:auto; box-shadow:0 0 0 1px rgba(0,0,0,.15); }
    ...
    .ql-editor img.stdq-img-selected { outline:2px solid var(--a-navy, #0b3d91); outline-offset:1px; }
    ...
    .stdq-img-action-btn { display:inline-flex; align-items:center; gap:5px; padding:4px 9px; background:#fff; border:1.5px solid var(--a-line,#c9d6ef); color:var(--a-navy,#0b3d91); font-size:11.5px; font-weight:700; border-radius:7px; cursor:pointer; box-shadow:0 4px 12px rgba(0,0,0,.15); white-space:nowrap; }
    .stdq-img-action-btn:hover { background:var(--a-bg,#f4f6fb); }
    .stdq-img-action-btn.is-reset { color:#b45309; border-color:#fed7aa; }
    .stdq-img-action-btn.is-reset:hover { background:#fff7ed; }
    .stdq-img-action-btn.is-viewer { background:var(--a-navy,#0b3d91); color:#fff; border-color:rgba(255,255,255,.85); }
    .stdq-img-action-btn.is-viewer:hover { background:var(--a-navy,#0b3d91); }
</style>
<script>
(function() {
