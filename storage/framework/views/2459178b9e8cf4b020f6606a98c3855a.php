...
<head>
    ...
    <title><?php echo $__env->yieldContent('code'); ?> <?php echo $__env->yieldContent('title'); ?> — 메디셀</title>
    <style>
...
<body>
    <div class="box">
        ...
        <p class="desc"><?php echo $__env->yieldContent('desc'); ?></p>
        <div class="actions">
            <a href="<?php echo e(url('/')); ?>" class="btn btn-primary">홈으로 가기</a>
            <a href="javascript:history.back()" class="btn btn-ghost">이전 페이지</a>
        </div>
        <div class="foot">
            메디셀(MEDISELL) 의료소모품 쇼핑몰 · <a href="<?php echo e(url('/community/inquiry')); ?>">고객문의</a>
        </div>
    </div>
</body>
</html>
<?php /**PATH E:\xampp\htdocs\medisell\resources\views/errors/minimal.blade.php ENDPATH**/ ?>