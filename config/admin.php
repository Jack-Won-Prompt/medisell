...
return [
    'categories' => [
        ...
        'fields' => [
            ...
            ['name' => 'slug', 'label' => '슬러그(영문 URL)', 'type' => 'text', 'unique' => true,
                'hint' => '비워두면 카테고리명에서 자동 생성됩니다. 중복되면 -2, -3 이 붙습니다.'],
    ...
    'brands' => [
        ...
        'fields' => [
            ...
            ['name' => 'slug', 'label' => '슬러그', 'type' => 'text', 'unique' => true,
                'hint' => '비워두면 브랜드명에서 자동 생성됩니다. 중복되면 -2, -3 이 붙습니다.'],
    ...
    'products' => [
        ...
        'fields' => [
            ...
            ['name' => 'slug', 'label' => '슬러그(영문 URL)', 'type' => 'text', 'unique' => true,
                'hint' => '비워두면 상품명(한글만이면 상품코드)에서 자동 생성됩니다. 중복되면 -2, -3 이 붙습니다.'],
